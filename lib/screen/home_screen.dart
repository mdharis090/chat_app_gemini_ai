...
class _Home_ScreenState extends State<Home_Screen> {
  ...
  void _sendMessage(ChatMessage chatMessage) {
    ...
    //     } else
    //     String Response = event.content != null?Parts?.fold("",(Previous,current)=>"$Previous$current") ?? "";

    //       ChatMessage message =
    //           ChatMessage(user: gemniuser, createdAt: DateTime.now(),text:resp,);
    //   });
    // } catch (e) {
    //   print(e);
    // }
